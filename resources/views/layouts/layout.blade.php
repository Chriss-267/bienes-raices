...
<head>
        ...
        <title>{{ config('Bienes Raices', 'Bienes Raices') }}</title>
        <meta name="description" content="{{ config('Bienes Raices', 'Bienes Raices') }}">
        <meta name="keywords" content="{{ config('Bienes Raices', 'Bienes Raices') }}">
        <meta name="author" content="{{ config('Bienes Raices', 'Bienes Raices') }}">

        <link rel="icon" type="image/ico" href="{{ asset('UPEDLOGO.ico') }}">
...
<body>
    ...
    <nav
        class="relative dark:bg-gray-800/50 dark:after:pointer-events-none dark:after:absolute dark:after:inset-x-0 dark:after:bottom-0 dark:after:h-px dark:after:bg-white/10">
            ...
            <div class="relative flex h-16 items-center justify-between">
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    <div class="flex shrink-0 items-center">
                        <a href="{{url('/')}}"><img src="{{ asset('LOGOUPED.png') }}"
                            alt="Your Company" class="h-8 w-auto" /></a>
        ...
        <div class="mx-auto w-full p-4 py-6 lg:py-8">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <div class="flex mt-4 sm:justify-center sm:mt-0">
                    ...
                    <a href="#" class="text-gray-500 hover:text-gray-200 dark:hover:text-white ms-5">
                        <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
